...
You can easily view the data and the output of the transformed SCC scan, verify that the model fitting is proceeding as expected, and check rejection locations with `plot_cond_vs_cont` and `plot_rejections_along_process`.
