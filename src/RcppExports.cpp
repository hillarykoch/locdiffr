...
// crun_sgp_correlated
Rcpp::List crun_sgp_correlated(double reps, int n, int p, double tau, arma::mat X, arma::mat PLDs_precision, double PLDs_ldet, arma::mat PLDe_precision, double PLDe_ldet, double errprec, arma::mat precision_beta, arma::mat y, int iters, double aas, double bs, double rhos, double nus, double rhoe, double nue, double r, double sd_r, double tune_vars, double tune_vare, double min_range, double max_range, double win_len, arma::mat d, arma::colvec acpt_rhos, arma::colvec acpt_rhoe, double c0, double c1, double tune_k, arma::mat acpt_chain, arma::mat tune_var_chain);
RcppExport SEXP _sgp_crun_sgp_correlated(SEXP repsSEXP, SEXP nSEXP, SEXP pSEXP, SEXP tauSEXP, SEXP XSEXP, SEXP PLDs_precisionSEXP, SEXP PLDs_ldetSEXP, SEXP PLDe_precisionSEXP, SEXP PLDe_ldetSEXP, SEXP errprecSEXP, SEXP precision_betaSEXP, SEXP ySEXP, SEXP itersSEXP, SEXP aasSEXP, SEXP bsSEXP, SEXP rhosSEXP, SEXP nusSEXP, SEXP rhoeSEXP, SEXP nueSEXP, SEXP rSEXP, SEXP sd_rSEXP, SEXP tune_varsSEXP, SEXP tune_vareSEXP, SEXP min_rangeSEXP, SEXP max_rangeSEXP, SEXP win_lenSEXP, SEXP dSEXP, SEXP acpt_rhosSEXP, SEXP acpt_rhoeSEXP, SEXP c0SEXP, SEXP c1SEXP, SEXP tune_kSEXP, SEXP acpt_chainSEXP, SEXP tune_var_chainSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type reps(repsSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(crun_sgp_correlated(reps, n, p, tau, X, PLDs_precision, PLDs_ldet, PLDe_precision, PLDe_ldet, errprec, precision_beta, y, iters, aas, bs, rhos, nus, rhoe, nue, r, sd_r, tune_vars, tune_vare, min_range, max_range, win_len, d, acpt_rhos, acpt_rhoe, c0, c1, tune_k, acpt_chain, tune_var_chain));
    return rcpp_result_gen;
END_RCPP
}
// fastMeanFilter
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sgp_crun_sgp_correlated", (DL_FUNC) &_sgp_crun_sgp_correlated, 34},
